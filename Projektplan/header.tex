...
\usepackage{amssymb,amsmath,fancybox,graphicx,wrapfig,color,lastpage,verbatim,epstopdf,a4wide, tabularx, makecell}
...
\usepackage{trfsigns}
\usepackage{textcomp}
\usepackage{tabu}	%for extended tabular
...
\definecolor{blue}{rgb}{0.25, 0.4, 0.96}
\definecolor{yellow}{rgb}{1.0, 0.75, 0.0}
\definecolor{violet}{rgb}{0.53, 0.0, 0.69}

\definecolor{redLight}{rgb}{1.0, 0.41, 0.38}
\definecolor{greenLight}{rgb}{0.47, 0.87, 0.47}
\definecolor{blueLight}{rgb}{0.45, 0.76, 0.98}
\definecolor{yellowLight}{rgb}{0.99, 0.99, 0.59}
