...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
	...
	%Includes	
	\include{content/intro/einleitung}
	\include{content/projektstrukturplan/Projektstrukturplan}
	\include{content/terminplan/terminplan}
	\include{content/funcReqs/funcReqs}
	\include{content/otherReqs/otherReqs}
